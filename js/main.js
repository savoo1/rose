...
$(document).ready(function () {
  ...
  function checkActiveSection() {
    ...
    $(".scroll").each(function () {
      ...
      if (
        section.offset().top - 200 <= scrollPos && // Adjust for offset
        section.offset().top + section.height() + 700 > scrollPos
      ) {
  ...
  $(".scroll").click(function (e) {
    ...
    if (targetSection !== "#") {
      ...
      $("html, body").animate(
        {
          scrollTop: $(targetSection).offset().top - 50, // Adjust scroll position for nav height
        },
        1000
      );
    }
